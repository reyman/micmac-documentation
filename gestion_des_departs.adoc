...
<1> Si c'est le cas (`in-airport = 1` et `out-airport = 1`), alors on execute la boucle suivante qui résoud les stratégies en même temps qu'elle construit et remplit les avions.
