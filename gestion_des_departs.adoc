...
<2> Sinon la population qui aurait du partir est considéré comme perdue. Attention, là encore cette population n'est pas soustraite des stocks car elle n'est jamais partie.
