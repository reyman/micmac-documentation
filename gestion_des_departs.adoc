...
La condition teste si il existe au moins un un aéroport voisin, dont l'entrée (`in-airport`) est disponible pour recevoir un vol.

<1> Si c'est le cas, alors on execute la boucle suivante qui construit et remplie les avions. 
