...
Ces trois globales sont passées en paramètres de la fonction `update-world`, son utilisation est décrite sur la page link:.\gestion_des_departs.adoc[gestion des départs].
