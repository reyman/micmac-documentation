...
En entrée, la procédure principale fait appel à deux variables globales :
...
Passé en paramètre de la fonction `update-world`, décrites un peu plus bas de de document, sont utilisation est décrite sur la page link:.\gestion_des_departs.adoc[gestion des départs]


`gcumulated-pop-flight-expected-float`::
bla
