...
Valeur calculé durant le calibrage du modèle, celle-ci est une valeur de référence indiquant le stock de population qui doit être si possible (les stratégies viennent evidemment impacter la réalisation de cet objectif) maitenu en vol à tout instant.
