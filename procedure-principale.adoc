...
Passé en paramètre de la fonction `update-world`, décrites un peu plus bas de de document, son utilisation est décrite sur la page link:.\gestion_des_departs.adoc[gestion des départs].
