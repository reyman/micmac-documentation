...
Valeur calculé durant le calibrage du modèle, celle-ci est une valeur de référence indiquant la part de population qui doit être si possible maintenu en vol à tout instant. Les stratégies viennent evidemment impacter la réalisation de cet objectif.
